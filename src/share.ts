...
/**
 * Высота помещения появилась в ссылке только с версии 4. Прежние ссылки её не
 * несут, и достроить её можно лишь типовым значением — оно намеренно отвязано
 * от умолчаний движка: там число можно менять, а смысл старых ссылок — нет.
 */
